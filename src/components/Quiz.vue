...
<template>
  ...
  <Restart v-else-if="store.step==2"></Restart>
  <div
    v-else
  ...
  >
    <div class="row-span-2">
      <div
        class="min-h-full justify-between py-4 rounded-lg flex flex-col items-center"
      >
        <div class="flex my-4">
          <div
      ...
      <div class="min-h-full flex flex-col justify-center">
        <div class="grid grid-cols-1 gap-4 md:gap-4 md:grid-cols-2">
          <Answer
            ...
            :text="answer"
            :is-valid-answer="
              answer == store.data[store.currentQuestion].correctAnswer
            "
            :is-invalid-answer="
              answer != store.data[store.currentQuestion].correctAnswer
            "
...
export default {
  ...
  created() {
    ...
    this.store.getData(route.params);
  },
